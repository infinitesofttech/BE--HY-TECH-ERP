...
class SubscriberList(models.Model):
    ...
    bounce_rate = models.DecimalField(max_digits=5, decimal_places=2, default=0, help_text='Bounce rate in %')
    last_campaign_date = models.DateField(null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
